const MODS_DATA = {
    ...
    "Графика": {
        "1.21.11": [
            ...
            { name: "Iris", desc: "Временно не запускается из-за конфликта с Sodium. Можно попробовать откатить версии, но исключительно на свой страх и риск." },
    ...
    "Сеть": {
        "1.21.11": [
            ...
            { name: "Very Many Players (Fabric)", desc: "Оптимизация для сервера с большим количеством игроков." }
        ],
        "1.21.4": [
